...
/* Publishes the immutable release assets named by repository.json.
 * Existing tags/assets are left untouched, so re-runs are safe. */
...
publish({
  ...
  title: `${index.name} Bundle ${index.bundle.version}`,
