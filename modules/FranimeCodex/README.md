...
The installable artifact is `dist/FRAnimeCodex-1.0.0-beta.4.zip`. It contains only the flat files `module.json` and `index.js`; the SHA-256 is in the adjacent `.sha256` file. This community test package uses identity `SP-VID-9002-FRANIME-CODEX-TEST` / number `9002`; it is not an official catalogue allocation.
