...
Attempted/passed/failed/blocked: **38 / 34 / 0 / 4**. Blocked reasons: three final live stream checks met provider HTTP 403/unavailable Sibnet routes; one browser check did not establish reliable playback controls or audio. Target platforms actually tested: Windows Node.js 24.13.1 kit runtime and Chrome visual rendering only. Remaining limitations: no Flutter/S2/device playback, audio/subtitle/download/offline certification, no maintainer identity allocation, and provider availability may vary. Release approval: not requested. Public user-owned testing-repository publication was authorized by the requester on 2026-09-17. Official catalogue publication remains out of scope pending maintainer identity allocation and approval.
