...
Module ID/name/version: `franime-v1` / FRAnime / `1.0.0-beta.3`  
...
Target Player version: not supplied; no Player build or S2 harness was available  
...
- No credentials, cookies, personal data, signed media URLs, or remote executable scripts are shipped in the module or report. Nothing was published and no app code or production service was changed.
...
- The manifest uses the development identity `PENDING-OWNER-ALLOCATION` / number `0`; maintainer allocation is required before public release.

## Final handoff

Version: `1.0.0-beta.3`  
ZIP: `C:\Users\INTERPOL\Downloads\Synthetiq-Module-Making-Kit.pre-expanded-20260917\Synthetiq-Module-Making-Kit\Franime\dist\FRAnime-1.0.0-beta.3.zip`  
SHA-256: `738489e47def3ef89b932935071ec36d1c3eac1bb193a88e6db8cc54c3092ab0`  
Attempted/passed/failed/blocked: **38 / 34 / 0 / 4**. Blocked reasons: three final live stream checks met provider HTTP 403/unavailable Sibnet routes; one browser check did not establish reliable playback controls or audio. Target platforms actually tested: Windows Node.js 24.13.1 kit runtime and Chrome visual rendering only. Remaining limitations: no Flutter/S2/device playback, audio/subtitle/download/offline certification, no maintainer identity allocation, and provider availability may vary. Release approval/publication: not requested; nothing was published.
